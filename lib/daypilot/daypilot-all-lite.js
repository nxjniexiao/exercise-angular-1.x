...
(function() {
  ...
  (function() {
    ...
    $m.add(
      ...
      'border: 1px solid #c0c0c0;font-family: Tahoma, Arial, sans-serif; font-size: 12px;'
    );
    $m.add(
    ...
    $m.add(
      ...
      'font-size: 16pt;text-align: right; position: absolute;top: 0px;left: 0px;bottom: 0px;right: 0px;border-right: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;'
    );
    $m.add(
    ...
    $m.add(
      ...
      'position: absolute;top: 2px;bottom: 2px;left: 2px;right: 2px;padding: 2px;margin-right: 1px;font-size: 12px;'
    );
    $m.add(
    ...
    $m.add(
      '.month_default_main',
      'border: 1px solid #c0c0c0;font-family: Tahoma, Arial, sans-serif; font-size: 12px;color: #333;'
    );
    $m.add(
    ...
    $m.add(
      ...
      'text-align: center; vertical-align: middle;position: absolute;top: 0px;left: 0px;bottom: 0px;right: 0px;border-right: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;cursor: default;color: #333;background: #f3f3f3;'
    );
    $m.add(
    ...
    $m.add(
      ...
      'background: #fff;background: -webkit-gradient(linear, left top, left bottom, from(#ffffff), to(#e8e8e8));background: -webkit-linear-gradient(top, #ffffff 0%, #e8e8e8);background: -moz-linear-gradient(top, #ffffff 0%, #e8e8e8);background: -ms-linear-gradient(top, #ffffff 0%, #e8e8e8);background: -o-linear-gradient(top, #ffffff 0%, #e8e8e8);background: linear-gradient(top, #ffffff 0%, #e8e8e8);filter: progid:DXImageTransform.Microsoft.Gradient(startColorStr="#ffffff", endColorStr="#e8e8e8");'
    );
    $m.add(
      '.month_default_selected .month_default_event_inner, .month_default_event_hover.month_default_selected .month_default_event_inner',
      'background: #ddd;'
    );
    $m.add(
  ...
  DayPilot.Stats.print = function() {
    ...
    console.log(
      'DayPilot.Stats.cacheHitsParsing: ' + DayPilot.Stats.cacheHitsParsing
    );
    console.log(
  ...
  DayPilot.Event = function($H, $10, $11) {
    ...
    this.client.backColor = function($O) {
      if (typeof $O === 'undefined') {
        ...
        return typeof e.data.backColor !== 'undefined'
          ? e.data.backColor
          : e.calendar.eventBackColor;
      } else {
        e.data.backColor = $O;
      }
    };
    this.client.borderColor = function($O) {
      if (typeof $O === 'undefined') {
        ...
        return typeof e.data.borderColor !== 'undefined'
          ? e.data.borderColor
          : e.calendar.eventBorderColor;
      } else {
    ...
    this.client.moveEnabled = function($O) {
      if (typeof $O === 'undefined') {
        return (
          e.calendar.eventMoveHandling !== 'Disabled' && !e.data.moveDisabled
        );
      } else {
    ...
    this.client.resizeEnabled = function($O) {
      if (typeof $O === 'undefined') {
        return (
          e.calendar.eventResizeHandling !== 'Disabled' &&
          !e.data.resizeDisabled
        );
      } else {
    ...
    this.client.clickEnabled = function($O) {
      if (typeof $O === 'undefined') {
        return (
          e.calendar.eventClickHandling !== 'Disabled' && !e.data.clickDisabled
        );
      } else {
  ...
  if (typeof DayPilot.JSON.stringify !== 'function') {
    DayPilot.JSON.stringify = function($Y, $1f, $1g) {
      ...
      if (
        $1f &&
        typeof $1f !== 'function' &&
        (typeof $1f !== 'object' || typeof $1f.length !== 'number')
      ) {
...
(function() {
  ...
  DayPilotCalendar.gMouseUp = function(e) {
    if (DayPilotCalendar.resizing) {
      ...
      $b.$1W($j.start, $j.end);
      if (
        $b.timeRangeSelectedHandling !== 'Hold' &&
        $b.timeRangeSelectedHandling !== 'HoldForever'
      ) {
        $a();
      }
    } else {
  ...
  DayPilotCalendar.moveShadow = function($l) {
    ...
    $k.style.width =
      DayPilotCalendar.movingShadow.parentNode.offsetWidth + 1 + 'px';
  };
  DayPilotCalendar.Calendar = function(id) {
    ...
    this.$25 = function($s, $t) {
      ...
      if ($s.UpdateType === 'Full') {
        ...
        $b.businessBeginsHour = $s.BusinessBeginsHour
          ? $s.BusinessBeginsHour
          : $b.businessBeginsHour;
        $b.businessEndsHour = $s.BusinessEndsHour
          ? $s.BusinessEndsHour
          : $b.businessEndsHour;
        $b.headerDateFormat = $s.HeaderDateFormat
          ? $s.HeaderDateFormat
          : $b.headerDateFormat;
        $b.viewType = $s.ViewType;
        $b.backColor = $s.BackColor ? $s.BackColor : $b.backColor;
        $b.eventHeaderVisible = $s.EventHeaderVisible
          ? $s.EventHeaderVisible
          : $b.eventHeaderVisible;
    ...
    this.$1V = function(e, $i, $I, ev) {
      ...
      var $Q =
        $K.getTime() -
        ($L.getTime() +
          $K.getUTCHours() * 3600 * 1000 +
          Math.floor($K.getUTCMinutes() / 30) * 30 * 60 * 1000);
      ...
      if (this.elements.events) {
        for (var i = 0; i < this.elements.events.length; i++) {
          ...
          if (
            ...
            $Y.firstChild.firstChild.tagName.toUpperCase() === 'IMG'
          ) {
    ...
    this.$2z = function(e) {
      ...
      $Y.onmousemove = function(ev) {
        ...
        if ($0i.y <= $0h && $b.eventResizeHandling !== 'Disabled') {
          ...
          this.offsetHeight - $0i.y <= $0g &&
          $b.eventResizeHandling !== 'Disabled'
        ) {
          if ($0j) {
    ...
    this.$2i = function() {
      ...
      $b.nav.scrollable.onmousemove = function(ev) {
        ...
        if (DayPilotCalendar.resizing) {
          if (!DayPilotCalendar.resizingShadow) {
            DayPilotCalendar.resizingShadow = $b.$2a(
              DayPilotCalendar.resizing,
              false,
              $b.shadow
            );
          }
          ...
          if (DayPilotCalendar.resizing.dpBorder === 'bottom') {
            var $0U =
              Math.floor(
                (DayPilotCalendar.originalHeight +
                  DayPilotCalendar.originalTop +
                  $0T +
                  $0S / 2) /
                  $0S
              ) *
            ...
            if (DayPilotCalendar.originalTop + $0U > $05)
              $0U = $05 - DayPilotCalendar.originalTop;
            DayPilotCalendar.resizingShadow.style.height = $0U + 'px';
          } else if (DayPilotCalendar.resizing.dpBorder === 'top') {
            var $0V =
              Math.floor(
                (DayPilotCalendar.originalTop + $0T - $J + $0S / 2) / $0S
              ) *
                $0S +
              $J;
            if ($0V < $J) {
            ...
            var $0U =
              DayPilotCalendar.originalHeight -
              ($0V - DayPilotCalendar.originalTop);
            if ($0U < $0S) {
              $0U = $0S;
            } else {
          ...
          if (!DayPilotCalendar.movingShadow) {
            DayPilotCalendar.movingShadow = $b.$2a(
              DayPilotCalendar.moving,
              !$b._ie,
              $b.shadow
            );
            DayPilotCalendar.movingShadow.style.width =
              DayPilotCalendar.movingShadow.parentNode.offsetWidth + 1 + 'px';
          }
          if (!$b.coords) {
            return;
          ...
          var $0V =
            Math.floor(($b.coords.y - $0i - $J + $0S / 2) / $0S) * $0S + $J;
          if ($0V < $J) {
            $0V = $J;
          }
          var $0c = $b.nav.events;
    ...
    this.$2L = function($K, end) {
      if (this.businessBeginsHour < this.businessEndsHour) {
        return !(
          $K.getHours() < this.businessBeginsHour ||
          $K.getHours() >= this.businessEndsHour ||
          $K.getDayOfWeek() === 6 ||
          $K.getDayOfWeek() === 0
        );
      }
    ...
    this.$2O = function() {
      ...
      var $11 =
        typeof this.$2Q.scrollpos !== 'undefined'
          ? this.$2Q.scrollpos
          : this.initScrollPos;
      if (!$11) {
        return;
    ...
    this.events.load = function($13, $14, $15) {
      ...
      var $1b =
        $b.eventsLoadMethod && $b.eventsLoadMethod.toUpperCase() === 'POST';
      if ($1b) {
        DayPilot.Http.ajax({
          method: 'POST',
          data: {
        ...
        var $1d =
          'start=' +
          $b.visibleStart().toString() +
          '&end=' +
          $b.visibleEnd().toString();
        if ($1c.indexOf('?') > -1) {
          $1c += '&' + $1d;
        } else {
          $1c += '?' + $1d;
      ...
      for (var i = 0; i < this.columns.length; i++) {
        ...
        for (var j = 0; j < length; j++) {
          ...
          if ($1p) {
            ...
            var $1t = $1r.boxBottom;
            ep.part.top =
              Math.floor(top / this.cellHeight) * this.cellHeight + 1;
            ep.part.height =
              Math.max(
                Math.ceil($1t / this.cellHeight) * this.cellHeight -
                  ep.part.top,
                this.cellHeight - 1
              ) + 1;
            ...
            if (
              ep.part.start.getTime() === $1n &&
              ep.part.end.getTime() === $1o
            ) {
              $1i[j] = true;
            }
          }
    ...
    this.$2U = function() {
      if (!$b.$1Y) {
        ...
        window.console &&
          window.console.log &&
          window.console.log(
            'DayPilot: cssOnly = false mode is not supported anymore.'
          );
      }
    };
    this.$3a = function() {
...
(function() {
  ...
  DayPilot.Modal = function($k) {
    ...
    this.$0g = function() {
      var $y = window;
      var $z = document;
      var scrollY = $y.pageYOffset
        ? $y.pageYOffset
        : $z.documentElement && $z.documentElement.scrollTop
        ? $z.documentElement.scrollTop
        : $z.body.scrollTop;
      var $A = function() {
        return $l.$0n().y;
      };
...
(function() {
  ...
  DayPilotMonth.Month = function($b) {
    ...
    this.events.load = function($k, $l, $m) {
      ...
      var $t =
        $c.eventsLoadMethod && $c.eventsLoadMethod.toUpperCase() === 'POST';
      if ($t) {
        DayPilot.Http.ajax({
          method: 'POST',
          data: {
    ...
    this.$1q = function(e) {
      ...
      $S.onmousedown = function(ev) {
        ...
        if ($T === 1) {
          ...
          if (
            ...
            $U.event = $S.event;
            $U.width =
              DayPilot.DateUtil.daysSpan($U.event.start(), $U.event.end()) + 1;
            $U.direction = this.style.cursor;
            DayPilotMonth.resizingEvent = $U;
          } else if (
            this.style.cursor === 'move' ||
            $c.eventMoveHandling !== 'Disabled'
          ) {
            $c.clearShadow();
      ...
      $S.onmousemove = function(ev) {
        ...
        if ($H.x <= $Y && $c.eventResizeHandling !== 'Disabled') {
          ...
          $S.clientWidth - $H.x <= $Y &&
          $c.eventResizeHandling !== 'Disabled'
        ) {
          if (e.part.endsHere) {
      ...
      for (var x = 0; x < $01; x++) {
        ...
        r.belongsHere = function(ev) {
          if (
            ...
            ev.start().getTime() === this.start.getTime()
          ) {
            return true;
          }
          return !(
            ev.end().getTime() <= this.start.getTime() ||
            ev.start().getTime() >= this.end.getTime()
          );
        };
        ...
        r.putIntoLine = function(ev, $B, $C, $A) {
          ...
          $D.isFree = function($B, $C) {
            ...
            for (var i = 0; i < this.length; i++) {
              if (
                !(
                  $B + $C - 1 < this[i].part.colStart ||
                  $B > this[i].part.colStart + this[i].part.colWidth - 1
                )
              ) {
                $06 = false;
              }
        ...
        r.getHeight = function() {
          return Math.max(
            this.lines.length * $c.lineHeight() + $c.cellHeaderHeight,
    ...
    this.$1t = function() {
      ...
      $0d.onmousemove = function(ev) {
        if (DayPilotMonth.resizingEvent) {
          ...
          if (
            $V.x === DayPilotMonth.movingEvent.coords.x &&
            $V.y === DayPilotMonth.movingEvent.coords.y
          ) {
            return;
          }
          var $W = $c.getCellBelowPoint($V.x, $V.y);
          ...
          var $G = $c.cellMode
            ? 1
            : DayPilot.DateUtil.daysSpan(event.start(), event.end()) + 1;
          if ($G < 1) {
            $G = 1;
          }
    ...
    this.drawCell = function(x, y, $0p) {
      ...
      var $0u = this.cellProperties
        ? this.cellProperties[y * this.getColCount() + x]
        : null;
...
(function() {
  ...
  DayPilot.Navigator = function(id) {
    ...
    this.$03 = function() {
      ...
      if (!this.startDate) {
        this.startDate = new DayPilot.Date(
          DayPilot.Date.fromYearMonthDay(this.year, this.month)
        );
      } else {
    ...
    this.$0k = function() {
      ...
      switch ($H) {
        case 'day':
          ...
          break;
        case 'week':
          this.selectionStart = this.selectionDay.firstDayOfWeek(
            $n.weekStarts()
          );
    ...
    this.select = function($I) {
      ...
      if ($J) {
        ...
        if (
          this.selectionStart.getTime() < this.visibleStart().getTime() ||
          this.selectionStart.getTime() > this.visibleEnd().getTime()
        ) {
    ...
    this.$0e = function($I) {
      ...
      if (
        this.selectionStart.getTime() <= $I.getTime() &&
        $I.getTime() <= this.selectionEnd.getTime()
      ) {
        return true;
      }
      return false;
        ...
        case 'month':
          ...
          for (var y = 0; y < 6; y++) {
            for (var x = 0; x < 7; x++) {
              ...
              if (
                s.day.getYear() === $w.getYear() &&
                s.day.getMonth() === $w.getMonth()
              ) {
                $a.$07(s, 'select');
                $a.selected.push(s);
                if ($O === null) {
