var app = angular.module('main', ['daypilot']).controller('DemoCtrl', [
  '$scope',
  '$timeout',
  function($scope, $timeout) {
    ...
    $scope.config = {
      ...
      separators: [
        ...
        {
          color: 'blue',
          location: new DayPilot.Date(new Date(new Date().getTime() + 3600000), true),
          layer: 'BelowEvents'
        },
      ],
      ...
      onRowClick: function(args) {
        ...
        var existingEvents = findEventsByRange(
          args.row.id,
          new Date('2019/09/01'),
          new Date('2019/09/30')
        );
    ...
    $scope.events = [
      {
        ...
        end: new DayPilot.Date(new Date(now.getTime() + 60 * 60 * 1000), true),
        id: DayPilot.guid(),
        resource: 'B',
        text: 'One-Day Event'
      }
